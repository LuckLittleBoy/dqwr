    	...
    	xhr.onreadystatechange=function(){	
    		if(xhr.readyState==4){
    			...
    			{				
    				...
    				var msg=eval('('+requestmsg+')');
					if(msg.title!=""){
    					document.getElementById("zcmc").value=msg.title;
    					}
   					if(msg.wh!=""){
       					document.getElementById("zcwh").value=msg.wh;
   					}
...
<div style="position: relative;min-height: 490px; " >
	...
	政策名称：<input  style="width:160px;"  type="text" size="20" id="zcmc" name="zcmc"><button onclick='gettitle();return false;'>s</button>&nbsp;&nbsp;&nbsp;&nbsp;
