...
<div align="center">
  ...
  <table id="__01" width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="38" colspan="3" background="images/index_0400.jpg"><span id="d" class="STYLE2"> 您的位置：首页->政策分析->族谱分析功能 </span></td>
      ...
      <table width="259"  border="0" cellpadding="0" cellspacing="0" >
	    ...
	    <td colspan="2" valign="top"><table width="785" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="748" background="images/2temp_11.jpg" ><font color="#FFFFFF"><img src="images/Developer_Icons_064.png" style="vertical-align: middle;" width="32" height="32"><span class="STYLE22">族谱分析功能</span></font>&nbsp;</td>
          ...
          <tr>
			...
			<!-- 内容 -->
			<div style="width: 100%;margin-top: 20px" align="center"><font size="6xp">族谱分析功能介绍</font></div>
            	<div style="width: 600px;margin-top: 20px;padding-left: 100px;">
            	<font size="4" style="width: 800px;line-height:32px;">
            	&nbsp;&nbsp;&nbsp;&nbsp;
            	<strong>
            	用户点击页面左侧边栏中“族谱分析”按钮，系统可对某一政策进行关联性（按“上位政策、施行范围”等著录项）梳理，绘制出与该政策相关的政策体系结构图（政策族谱）。
            	</strong>
            	</font>
            	</div>
			<!-- 内容 -->
