...
<script type="text/javascript" src="js/yjfk.js"></script>
...
<div align="center">
  ...
  <table id="__01" width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="38" colspan="3" background="images/index_0400.jpg"><span class="STYLE2" id="d">您的位置：首页->意见反馈</span></td>
    ...
    <tr>
	    ...
	    <td colspan="4" valign="top"><table width="1044" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="1007" background="images/2temp_11.jpg" ><font color="#FFFFFF"><img src="images/Developer_Icons_064.png" style="vertical-align: middle;" width="32" height="32"><span class="STYLE22">意见反馈</span></font><span class="STYLE22">&nbsp;</span></td>
          ...
          <tr>
            ...
            <!-- 系统介绍内容 -->
            <div style="width: 100%;margin-top: 20px" align="center"><font size="3">请留下您的宝贵意见(</font><font color="red">红色必填,注册后才能提交</font><font size="3">)</font></div>
            	<div style="width: 800px;margin-top: 30px;padding-left: 150px;">
            	<%if(wbuser!=null){ %>
            	<input type="hidden" value="<%=wbuser.getUsername() %>" id="user">
            	<%}else{ %>
            	...
            	<tr ><td align="right">您是通过什么方式知道本服务平台的？</td><td><input id="fs" type="text"><font color=red>*</font></td></tr>
            	<tr ><td align="right">您想了解什么政策信息？</td><td><input id="ljxx" type="text"><font color=red>*</font></td></tr>
            	<tr ><td align="right">您对我们有什么建议和要求？</td><td><input id="jyyq" type="text"></td></tr>
            	<tr ><td align="right" valign="top">您认为本服务平台栏目设置是否满足您的需求？</td><td><textarea id="xq" rows="5" cols="30"></textarea><font color=red>*</font></td></tr>
            	<tr ><td align="right" valign="top">您希望增加什么栏目或信息？</td><td ><textarea id="xw" rows="5" cols="30"></textarea><font color=red>*</font></td></tr>
            	<tr ><td align="right">您的联系方式：</td><td><input type="text" id="lxfs" ><font color=red>*</font></td></tr>
            	<tr ><td align="right">验证码</td><td><input type="text" id="yzm"><img src="images/randCode.jsp" id='shuaxin' width="50" height="25"><font color=red>*</font></td></tr>
            	</table>
            	<div style="width: 100%;" align="center">
            	<br>
            	<input type="button" id="tj" value="发送">
            	</div>
            	</div>
            <!-- 系统介绍内容 -->
           </td>
