...
<div align="center">
  ...
  <table id="__01" width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="38" colspan="3" background="images/index_0400.jpg"><span class="STYLE2" id="d">您的位置：首页->免责声明</span></td>
    ...
    <tr>
	    ...
	    <td colspan="4" valign="top"><table width="1044" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="1007" background="images/2temp_11.jpg" >&nbsp;</td>
          ...
          <tr>
            ...
            <div style="width: 100%;margin-top: 20px" align="center"><font size="15xp">免责声明</font></div>
            	...
            	&nbsp;&nbsp;&nbsp;&nbsp;河北省科技情报研究院科技政策服务平台由河北省科学技术情报研究院研建。本系统旨在建立一个集科技政策数据存储、查询检索、统计分析等功能于一体的科技政策服务平台。为保证系统运行的正常化、正规化、合法化，提供给受众便捷、全面、稳定的服务，特发布如下声明。　
<br>1、本系统发布的科技政策均来源于有关部门官方网站已发布的正式文件，政策内容存在的问题，与本系统无关。本系统不承担用户因采用本系统发布的信息而产生的任何损失和法律纠纷。
<br>2、本系统对科技政策数据的加工属于我方个体行为，准确性可能存在偏差，对于用户采用本系统数据带来的错误以及产生的任何损失，本系统不承担任何责任。
<br>3、本系统提供的信息，用于为科技管理人员和政策研究人员提供服务，禁止用于商业交易或谋利活动，违者后果自负。
            	</font>
            	</div>
            <!-- 系统介绍内容 -->
           </td>
