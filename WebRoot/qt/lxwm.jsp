						...
						<tr>
							...
							<td width="1007" background="images/2temp_11.jpg"><font
								color="#FFFFFF"><img src="images/Developer_Icons_064.png"
									...
									class="STYLE22">联系我们</span></font><span class="STYLE22">&nbsp;</span></td>
							<td width="16"><img src="images/2temp_12.jpg" width="17"
								height="41"></td>
						</tr>
						<tr>
							<td height="550" background="images/2temp_13.jpg">&nbsp;</td>
							<td class="center" background="images/erjibg.jpg" valign="top"
								bgcolor="#FFFFFF">
								<!-- 系统介绍内容 -->
								<div style="width: 100%; margin-top: 20px" align="center">
									<font size="15xp">联系我们</font>
								</div>
								<div
									style="width: 300px; margin-top: 100px; margin-left: 350px;">
									<font size="4" style="width: 300px; line-height: 32px;">
										单位：河北省科学技术情报研究院 <br>地址：石家庄市青园街233号 <br>邮编：050021 <br>电话；0311—85809325
