...
<div align="center">
  ...
  <table id="__01" width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="38" colspan="3" background="images/index_0400.jpg"><span id="d" class="STYLE2"> 您的位置：首页->政策查询 ->全文检索功能 </span></td>
      ...
      <table width="259"  border="0" cellpadding="0" cellspacing="0" >
	    ...
	    <td colspan="2" valign="top"><table width="785" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="748" background="images/2temp_11.jpg" ><font color="#FFFFFF"><img src="images/Developer_Icons_064.png" style="vertical-align: middle;" width="32" height="32"><span class="STYLE22">全文检索功能</span></font>&nbsp;</td>
          ...
          <tr>
			...
			<!-- 内容 -->
			<div style="width: 100%;margin-top: 20px" align="center"><font size="6xp">全文检索功能介绍</font></div>
            	<div style="width: 600px;margin-top: 20px;padding-left: 100px;">
            	<font size="4" style="width: 800px;line-height:32px;">
            	&nbsp;&nbsp;&nbsp;&nbsp;
            	<strong>
            	用户在检索方式中选择“全文检索”，默认显示全文检索页面，用户可结合政策法规中的关键字段进行全文检索。检索结果显示与检索内容匹配度最高的政策内容列表，与检索内容相关的检索词将高亮显示。用户可点击检索结果中的政策标题打开政策全文，进行相关内容的查找与比对。
            	</strong>
            	</font>
            	</div>
			<!-- 内容 -->
