...
<div align="center">
  ...
  <table width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="38" colspan="3" background="qt/images/index_0400.jpg"><span class="STYLE2">您的位置：首页->政策解读原文</span></td>
    ...
    <tr align="center">
	    <td align="center" colspan="4" valign="top"><table width="1044" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="1007" background="qt/images/2temp_11.jpg" ><font color="#FFFFFF"><img src="qt/images/Developer_Icons_064.png" style="vertical-align: middle;" width="32" height="32"><span class="STYLE22">政策解读</span></font><span class="STYLE22">&nbsp;</span></td>
...
function zx(){
	...
	jQuery.post("qtzx",
			function(response){
		location.replace('qt/denglu.jsp');
	});
}
window.onload = function(){
    //一般来说，当前所在页面不需要加链接
    document.getElementById('d').innerHTML = '&nbsp;&nbsp;您的位置：<a href="qt/index.jsp">首页</a>->政策解读';
}
