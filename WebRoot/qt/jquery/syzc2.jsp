...
%>
		...
		%>
<table  width='100%' >
		<tr align="center"><th width='40px'>序号</th><th>政策名字</th><th>政策文号</th><th width='100px'>政策类别</th><th >审核人</th><th >时效状态</th><th width='80px'>目前状态</th>	</tr >
		<%
			int i=0;
		...
		%>
				...
				<tr align="center" bgcolor="<%=bg %>">
					...
					<%if("保存".equals(policytag.getZSHZT())){ %>
							<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/kjzc/llyw?pno=<%=policytag.getZCID() %>" style="color: red"><%=policytag.getZCMC() %></a></td>
					
						<%}else{ %>
							<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/kjzc/llyw?pno=<%=policytag.getZCID() %>"><%=policytag.getZCMC() %></a></td>
