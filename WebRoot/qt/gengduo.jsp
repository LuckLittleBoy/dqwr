...
%>
<script language="JavaScript" src="js/gengduo.js"></script>
...
.news td,th {
	background: expression((                                        
		    this.parentNode.rowIndex)%2==0?"#3DB7CC":"#B3F4FF" );
}
	...
	<div align="center">
		...
		<table id="__01" width="1046" height="968" border="0" cellpadding="0"
			...
			<tr>
				<td height="38" colspan="3" background="images/index_0400.jpg"><span
					id="d" class="STYLE2">您的位置：首页->政策导航->政策专题</span></td>
			...
			<tr bgcolor="#FEFEFE">
				<td colspan="2" border="0" valign="top">
					...
					</table> <!-- 政策专题 --> <input type="hidden" name="" id="tiaozhuan">
					...
					name="pageCount" id="pageCount"> <!-- 模板 -->
				</td>
				<!--center 模板 -->
				<td colspan="2" valign="top" id="centerright"></td>
				<!--center 模板 -->
			</tr>
			<tr>
      ...
      <select onChange="window.open(this.options[this.selectedIndex].value)">
      	...
      	<option  value="http://www.google.com/">goole</option>
			...
			<tr>
				<td colspan="4" rowspan="2" background="images/index_11.jpg"><div
