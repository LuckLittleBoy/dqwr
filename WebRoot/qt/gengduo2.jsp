<%@ page language="java" contentType="text/html; charset=UTF-8"
	import="java.util.*,com.satp.entity.*" import="com.dqwr.entity.*"
	pageEncoding="UTF-8"%>
...
<script language="JavaScript" src="js/gengduo2.js"></script>
...
<body>
	<div align="center">
		...
		<table id="__01" width="1046" height="968" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="132" colspan="4"><img src="images/index_01.jpg"
					width="1046" height="132"></td>
			</tr>
			<tr>
				<td height="42" colspan="4" background="images/index_0300.jpg">
					<div class="nav">
						<div align="center" class="navinner" class="tag">
							<ul class="navlist">
								<li><a
									href="${pageContext.request.contextPath}/qt/index.jsp"
									style="color: #FFFFFF">首页</a></li>
								<li><a
									href="${pageContext.request.contextPath}/qt/zcfl.jsp"
									style="color: #FFFFFF">政策导航</a></li>
								<li><a
									href="${pageContext.request.contextPath}/qt/qtcx.jsp"
									style="color: #FFFFFF">政策查询</a></li>
								<li><a
									href="${pageContext.request.contextPath}/qt/qttjfx.jsp"
									style="color: #FFFFFF">政策分析</a></li>
								<li><a
									href="${pageContext.request.contextPath}/qt/zcjd.jsp"
									style="color: #FFFFFF">政策解读</a></li>
								<li><a
									href="${pageContext.request.contextPath}/qt/xtjs.jsp"
									style="color: #FFFFFF">系统介绍</a></li>
								<li><a
									href="${pageContext.request.contextPath}/qt/denglu.jsp"
									style="color: #FFFFFF">用户登陆</a></li>
							</ul>
						</div>
					</div>
			</tr>
			<tr>
				<td height="38" colspan="3" background="images/index_0400.jpg"><span
					id="d" class="STYLE2">您的位置：首页->政策导航->政策专题->政策原文</span></td>
				<td height="38" background="images/index_0400.jpg" class="STYLE2"><div
						align="right">
						<div id="nowtime" style="float: right;"></div>
						<%
							if (wbuser != null) {
						%>
						<div style="float: right;">
							欢迎：<%=wbuser.getUsername()%>&nbsp;&nbsp;&nbsp;<a href="#" id="zx"
			...
			<tr bgcolor="#FEFEFE">
				<td colspan="2" border="0" valign="top">
					...
					<table width="259" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td height="41" background="images/temp_09.jpg"><div
									align="center">
									<span class="STYLE5"><img align="Bottom"
										src="images/Developer_Icons_014.png" width="32" height="32"
										style="vertical-align: middle;">&nbsp;政策专题</span>
								</div></td>
						</tr>
						<tr>
							<td height="162" background="images/temp_11.jpg">
								<ul style="list-style: none;" id="leftzczt" class="leftul">
					...
					<!-- 政策专题 --> <input type="hidden" name="" id="tiaozhuan">
					<input type="hidden" name="type" id="type"> <input
					type="hidden" name="lb" id="lb"> <input type="hidden"
					name="pageno" id="pageno"> <input type="hidden"
				...
				<td colspan="2" valign="top" id="centerright">
					<table width="785" height="606" border="0" cellpadding="0"
						cellspacing="0">
						<tr>
						...
						<tr>
							...
							<td class="center" valign="top" bgcolor="#FFFFFF">
								<div
									style="margin: 10px 10px 5px 10px; background-color: white; height: 98%; min-height: 550px;"
									align="center">
									<table width='96%'>
										<%
										...
										<tr align="left">
											<th
												style="font-style: normal; font-weight: normal; font-family: inherit;">
												<%=policytag.getPolciycontent()%>
											</th>
										</tr>
									</table>
								</div> <!-- <table width="200" border="0" cellpadding="0" cellspacing="0" align="center">
              <tr>
          ...
          <td width="50%" align="left" valign="bottom">1234abc</td>
              ...
              <tr>
                <td colspan="2"><img src="images/denglu_04.jpg" width="248" height="113" border="0" usemap="#Map"></td>
						...
						<tr>
							<td height="14"><img src="images/2temp_17.jpg" width="21"
								height="14"></td>
