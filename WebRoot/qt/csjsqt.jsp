...
<html>
  <head>
    ...
    <script language="javascript">
     ...
     /* 	//测试
     	$("#testYang").click(function(){
    		alert("测试");  
    	});*/
    </script>
  </head>
  <body bgcolor="#6CA6CD">
<!--   <div><input type="button" value="测试" id="testYang"></div>
 -->  <div align="center" style="margin: 5px 0px 0px 0px;background-color: white;">
  ...
  <%
				...
				%>
  <form action="TechServletqt" method="post" enctype="multipart/form-data">
   ...
   <font color="red">(*必填)</font>
    ...
    <tr>
     ...
     <td><input type="checkbox" name="fieldid" id="fieldid" value="新能源技术">新能源技术
         ...
         <input type="checkbox" name="fieldid" id="fieldid" value="其他">其他，请注明(可多选)
         <input type="text" name="otherfield" style="width: 117px; ">
     </td>
     </tr>
       <tr>
     <td>技术简介</td>
