...
#zcjdtable tr{height:40px}
#zcjdtable table  td,th{border-top:1px solid #FEFEFE;}
...
.zcjdtable table { border-collapse:collapse; border-spacing:0; }
/*#zcjdtable td { margin:0; padding:10px; border:1px solid #ccc; }


#zcjdtable table tr{padding:3px 3px 3px 3px;}
#zcjdtable table tr th{background-color:#C0E4FA;}
#zcjdtable table tr td{background-color:white;} */

.zcjdtable a{color: #000000;}
...
<div align="center">
  ...
  <table width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    <tr>
    ...
    <tr>
      <td height="38" colspan="3" background="images/index_0400.jpg"><span class="STYLE2">您的位置：首页->政策解读</span></td>
    ...
    <tr align="center">
	    <td align="center" colspan="4" valign="top"><table width="1044" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="21" height="41"><img src="images/2temp_10.jpg" width="21" height="41"></td>
            <td width="1007" background="images/2temp_11.jpg" ><font color="#FFFFFF"><img src="images/Developer_Icons_064.png" style="vertical-align: middle;" width="32" height="32"><span class="STYLE22">政策解读</span></font>
			<span  style="float: right;margin-top: 5px;">
			    <strong  ><font color="#FFFFFF">标题搜索:</font></strong>
			    <input type="text" id='searchnr'>
			   	<input  id="search" type="button" value="搜索" style="">
            </span>
            </td>
            <td width="16"><img src="images/2temp_12.jpg" width="17" height="41">
          ...
          <tr>
            ...
            <td class="center" valign="top" bgcolor="#FFFFFF">
			    ...
			    <table id="zcjdtable" border="0"  cellpadding="0" cellspacing="0" class="zcjdtable" width='100%'></table>
				<div id="bottom"></div>
           </td>
...
window.onload = function(){
    //一般来说，当前所在页面不需要加链接
    document.getElementById('d').innerHTML = '&nbsp;&nbsp;您的位置：<a href="'+ param.url +'">'+ decodeURI(param.pn) +'</a>->政策解读';
}
