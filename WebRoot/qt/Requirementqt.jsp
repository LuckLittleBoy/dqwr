...
<script type="text/javascript" src="/dqwr/qt/js/jquery-1.9.1.min.js"></script>
<!-- <script type="text/javascript" src="js/Calendar.js"></script> -->
<!-- <script language="JavaScript" src="js/requirement.js"></script>
 --> 
<!--
...
<body bgcolor="#6CA6CD">
	<button onclick="display()">hhe</button>
	<div align="center"
		...
		<form action="OrgaServlet1" method="post"  >
			<br>
