					...
					<div id="body" style="border-color: #000">
						...
						<div
							...
							<img style="margin-left: 15px;" src="images/tubiao.jpg"
								width="12px" height="12px;" id="fabu"><a href="<%=path%>/qt/qttjfx1.jsp?look=1">我要发布</a>
							<!-- 嵌入添加 -->
							<!-- ajax添加 -->
						...
						<div
							...
							align="left">
							<img style="margin-left: 15px;" src="images/tubiao.jpg"
								width="12px" height="12px;"><a href="<%=path%>/qt/qttjfx1.jsp?look=2">我已发布</a>
						</div>
						<div
							style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
							align="left">
						...
						<div
							...
							<img style="margin-left: 15px;" src="images/tubiao.jpg"
								...
								<a href="<%=path%>/qt/qttjfx1.jsp?look=3">我已发布</a>
						</div>					 
						<br> <br> <br> <br> <br>
					</div> <font></font>
				</td>
												...
												<table bgcolor="#FFFFFF" cellspacing="1" cellpadding="0"
													...
													<tbody>
														<tr id="row1">
															...
															<input type="text" size="50" maxlength="80" name="q0"
																id="q0"> 
						...
						<div style="height: 500px; width: 855px; margin-left: 10px"
							...
							<%
								int pageno1 = 0;
																		...
																		if (num == null) {
																			...
																			requirelist = Brose.ReuireList1(con, pageno1, pagesize1);
																			pageCount1 = Brose.RequirePagecount1(con, pageno1, pagesize1);
																			if (pageno1 > pageCount1) {
																				pageno1 = 1;
																				requirelist = Brose.ReuireList1(con, pageno1, pagesize1);
																				pageCount1 = Brose.RequirePagecount1(con, pageno1,
																						pagesize1);
																			}
																			...
																			requirelist = Brose.RequireList2(con, pageno1, pagesize1, num,
																					sType0, q0, logic1, sType1, q1, logic2, sType2, q2);
																			pageCount1 = Brose
																					.RequirePagecount2(con, pageno1, pagesize1, num,
																							sType0, q0, logic1, sType1, q1, logic2, sType2,
																							q2);
																			if (pageno1 > pageCount1) {
																				pageno1 = 1;
																				requirelist = Brose.RequireList2(con, pageno1, pagesize1,
																						num, sType0, q0, logic1, sType1, q1, logic2,
																						sType2, q2);
																				pageCount1 = Brose.RequirePagecount2(con, pageno1,
							...
							<table width='100%'>
								...
								<tr align="left" bgcolor="<%=bg%>">
									...
									<td><a id="href1" href=""
										onclick="createRequest('ShowRequireDetail.jsp?requid=<%=require.getRequId()%>','refresh');return false;"><%=require.getRequName()%></a></td>
							...
							<div style="background: #C0E4FA; position: relative;">
								<div style="background: #C0E4FA; position: absolute;"
									...
									条最新记录，当前页第<%=pageno1%>/<%=pageCount1%>页 &nbsp;&nbsp; <a
										href="qttjfx.jsp?pageno=<%if((pageno1+1)<1) out.print(1);else out.print(pageno1-1);%>">上一页</a>&nbsp;&nbsp;<a
										href="qttjfx.jsp?pageno=<%if((pageno1+1)>pageCount1) out.print(pageCount1);else out.print(pageno1+1);%>">下一页</a>
								</div>
								<form name="form1" method="post" action="qtcx.jsp">
									<div align="right">
										<a href="qttjfx.jsp?pageno=1">首页</a>&nbsp;&nbsp;<a
											href="qttjfx.jsp?pageno=<%=pageCount1%>">尾页</a> 跳转到 <input
