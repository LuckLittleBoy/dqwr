<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    import="com.dqwr.technology.entity.*"	
	import="java.text.SimpleDateFormat"
	import="com.dqwr.requirement.dao.impl.*"
	import="com.dqwr.requirement.entity.*"
	import="com.dqwr.expert.daoimpl.*"
	import="com.dqwr.expert.entity.*" 
	 pageEncoding="UTF-8"%>
<%
...
<script type="text/javascript">
	...
	function addRow() {
		...
		e2.id = "sType" + strId;
		e2.size = 1;
		e2.options[0] = new Option("组织编号", "OrgaId");
		e2.options[1] = new Option("组织名称", "OrgaName");
		e2.options[2] = new Option("所属行业", "IndustryID");		
	...
	function addRow1() {
		...
		e2.options[0] = new Option("专家编号", "ExpertID");
		e2.options[1] = new Option("专家姓名", "ExpertName");
		e2.options[2] = new Option("专业领域", "EngageSpec");	
		var q1 = document.createElement("input");
		q1.type = "text";
		q1.size = 50;
		q1.maxlength = 60;
		...
		<tr>
						...
						<div id="body">
							...
							<div
								...
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a href="<%=path%>/qt/qtcx2.jsp?look=3">找合作</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a href="<%=path%>/qt/qtcx2.jsp?look=4">找技术</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px;"
								align="left" id="huoqu">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a href="<%=path%>/qt/qtcx2.jsp?look=1">找机构</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a href="<%=path%>/qt/qtcx2.jsp?look=2">找人才</a>
								<!-- javascript:a("qt/expert1.jsp?exppass=2","136"); -->
							</div>
				...
				if (wbuser != null) {
					//找机构
					  if(look!=null){
						  if(look.equals("1")){
					%> 					
					<form name="thisform" action="qtcx2.jsp" method="get"
			...
			<table width='100%'>
								<tr align="center" bgcolor="#c0e4fa">
									<th width='40px'>序号</th>
									<th width='150px' >组织编号</th>
									<th width='300px'>组织名称</th>
									<th>所属行业</th>
								</tr>
								<%
									int i = 0;
								...
								<tr align="left" bgcolor="<%=bg%>">
									<td align="center"><%=i%></td>
 									<td align="center">	<a id="href1" href=""
									onclick="createRequest('showOrga.jsp?OrgaId=<%=orga.getOrgaId()%>&look=<%= look %>','refresh');
									return false;"><%=orga.getOrgaId()%></a></td>
 								<td align="left">	<a id="href1" href=""
									onclick="createRequest('showOrga.jsp?OrgaId=<%=orga.getOrgaId()%>&look=<%= look %>','refresh');
									return false;"><%=orga.getOrgaName()%></a></td>
							...
							<div style="background: #C0E4FA; position: absolute;"
								...
								条最新记录，当前页第<%=pageno1%>/<%=pageCount1%>页 &nbsp;&nbsp; <a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)<1) out.print(1);else out.print(pageno1-1);%>&look=1">上一页</a>&nbsp;&nbsp;<a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)>pageCount1) out.print(pageCount1);else out.print(pageno1+1);%>&look=1">下一页</a>
							</div>
							<form name="form1" method="post" action="qtcx2.jsp?look=<%= look %>">
								<div align="right">
									<a href="qtcx2.jsp?pageno=1&look=1">首页</a>&nbsp;&nbsp;<a
										href="qtcx2.jsp?pageno=<%=pageCount1%>&look=1">尾页</a> 跳转到 <input
											...
											<td colspan="2" align="left" bgcolor="#FFFFFF"
												...
												<table bgcolor="#FFFFFF" cellspacing="1" cellpadding="0"
													...
													<tbody>
														<tr id="row1">
															<td style="width: 60px;" align="center"><img
																src="images/11.gif" title="增加限制条件" onclick="addRow1()"
																style="cursor: hand;"> <img src="images/22.gif"
																title="移除限制条件" onclick="removeRow()"
																style="cursor: hand;"></td>
															<td><select name="sType0" size="1">
																	<option value="ExpertID">专家编号</option>																	
																	<option value="ExpertName">专家姓名</option>
																	<option value="EngageSpec">专业领域</option>
 															</select> <input type="text" size="50" maxlength="80" name="q0"
			...
			<%
				...
				if (num == null) {
					System.out.println("你进入无num操作");
					expertlist = Expertmodel.Expertlist1(con, pageno1, pagesize1);
					pageCount1 = Expertmodel.ExpertPagecount1(con, pageno1, pagesize1);
					if (pageno1 > pageCount1) {
						pageno1 = 1;
						expertlist =Expertmodel.Expertlist1(con, pageno1, pagesize1);
						pageCount1 = Expertmodel.ExpertPagecount1(con, pageno1,
								pagesize1);
					}
					...
					expertlist =Expertmodel.ExpertList2(con, pageno1, pagesize1, num,
							sType0, q0, logic1, sType1, q1, logic2, sType2, q2);
					pageCount1 = Expertmodel
							.ExpertPagecount2(con, pageno1, pagesize1, num,
									sType0, q0, logic1, sType1, q1, logic2, sType2,
									q2);
					if (pageno1 > pageCount1) {
						pageno1 = 1;
						expertlist = Expertmodel.ExpertList2(con, pageno1, pagesize1,
								num, sType0, q0, logic1, sType1, q1, logic2,
								sType2, q2);
						pageCount1 = Expertmodel.ExpertPagecount2(con, pageno1,
								pagesize1, num, sType0, q0, logic1, sType1, q1,
								logic2, sType2, q2);
					}
				}
			...
			<table width='100%' >
								<tr align="center" bgcolor="#c0e4fa">
									<th width='40px'>序号</th>
									<th width='200px'>专家编号</th>
									<th width='150px'>专家姓名</th>
									<th width='300px'>专业领域</th>
								</tr>
								<%
									int i = 0;
								...
								<tr align="left" bgcolor="<%=bg%>">
									<td align="center"><%=i%></td>
									<td align="center">	<a id="href1" href=""
									onclick="createRequest('showExpert.jsp?expertid=<%=expert.getExpertID()%>&look=<%= look %>','refresh');
									return false;"><%=expert.getExpertID()%></a></td>
								<td align="center"><a id="href1" href=""
									onclick="createRequest('showExpert.jsp?expertid=<%=expert.getExpertID()%>&look=<%= look %>','refresh');
									return false;"><%=expert.getExpertName()%></a></td>
									<td align="center"><%=expert.getEngageSpec()%></td>
								</tr>
								<%
									} else {
																	bg = "#F0F0F0";
								...
								<tr align="left" bgcolor="<%=bg%>">
									...
									<td align="center"><a id="href1" href=""
									onclick="createRequest('showExpert.jsp?expertid=<%=expert.getExpertID()%>&look=<%= look %>','refresh');
									return false;"><%=expert.getExpertName()%></a></td>									<td align="center"><%=expert.getEngageSpec()%></td>
								</tr>
								<%
									}
								%>
							...
							<div style="background: #C0E4FA; position: absolute;"
								...
								<%=i%>
								条最新记录，当前页第<%=pageno1%>/<%=pageCount1%>页 &nbsp;&nbsp; <a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)<1) out.print(1);else out.print(pageno1-1);%>&look=2">上一页</a>&nbsp;&nbsp;<a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)>pageCount1) out.print(pageCount1);else out.print(pageno1+1);%>&look=2">下一页</a>
							</div>
							<form name="form1" method="post" action="qtcx2.jsp?look=<%= look %>">
								<div align="right">
									<a href="qtcx2.jsp?pageno=1&look=2">首页</a>&nbsp;&nbsp;<a
										href="qtcx2.jsp?pageno=<%=pageCount1%>&look=2">尾页</a> 跳转到 <input
										type="text" size="1" style="width: 20px; height: 15px;"
										name="pageno" id="jumpPageNo" ></input>页&nbsp;&nbsp;<a href="#"
										onclick="form1submit()">跳转</a>
								</div>
											...
											<td colspan="2" align="left" bgcolor="#FFFFFF"
												...
												<table bgcolor="#FFFFFF" cellspacing="1" cellpadding="0"
													...
													<tbody>
														<tr id="row1">
															<td style="width: 60px;" align="center"><img
																src="images/11.gif" title="增加限制条件" onclick="addRow2()"
																style="cursor: hand;"> <img src="images/22.gif"
																title="移除限制条件" onclick="removeRow()"
																style="cursor: hand;"></td>
															<td><select name="sType0" size="1">
			...
			<%
				...
				if (num == null) {
					System.out.println("你进入无num操作");
					requirelist = Brose.ReuireListcx1(con, pageno1, pagesize1);
					pageCount1 = Brose.RequirePagecountcx1(con, pageno1, pagesize1);
					if (pageno1 > pageCount1) {
						pageno1 = 1;
						requirelist = Brose.ReuireListcx1(con, pageno1, pagesize1);
						pageCount1 = Brose.RequirePagecountcx1(con, pageno1,pagesize1);
					...
					requirelist = Brose.RequireListcx2(con, pageno1, pagesize1, num,
							sType0, q0, logic1, sType1, q1, logic2, sType2, q2);
					pageCount1 = Brose.RequirePagecountcx2(con, pageno1, pagesize1, num,
									sType0, q0, logic1, sType1, q1, logic2, sType2,
									q2);
					if (pageno1 > pageCount1) {
						pageno1 = 1;
						requirelist = Brose.RequireListcx2(con, pageno1, pagesize1,
								num, sType0, q0, logic1, sType1, q1, logic2,
								sType2, q2);
						pageCount1 = Brose.RequirePagecountcx2(con, pageno1,
								pagesize1, num, sType0, q0, logic1, sType1, q1,
								logic2, sType2, q2);
					}
				}
			...
			<table width='100%'>
								...
								<tr align="left" bgcolor="<%=bg%>">
									<td align="center"><%=i%></td>
									<td><a id="href1" href=""
										onclick="createRequest('ShowRequireDetail.jsp?requid=<%=require.getRequId()%>&look=<%= look %>','refresh');return false;"><%=require.getRequName()%></a></td>
							...
							<div style="background: #C0E4FA; position: absolute;"
								...
								<%=i%>
								条最新记录，当前页第<%=pageno1%>/<%=pageCount1%>页 &nbsp;&nbsp; <a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)<1) out.print(1);else out.print(pageno1-1);%>&look=3">上一页</a>&nbsp;&nbsp;<a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)>pageCount1) out.print(pageCount1);else out.print(pageno1+1);%>&look=3">下一页</a>
							</div>
							<form name="form1" method="post" action="qtcx2.jsp?look=<%= look %>">
								<div align="right">
									<a href="qtcx2.jsp?pageno=1&look=3">首页</a>&nbsp;&nbsp;<a
										href="qtcx2.jsp?pageno=<%=pageCount1%>&look=3">尾页</a> 跳转到 <input
										type="text" size="1" style="width: 20px; height: 15px;"
										name="pageno" id="jumpPageNo" ></input>页&nbsp;&nbsp;<a href="#"
										onclick="form1submit()">跳转</a>
								</div>
											...
											<td colspan="2" align="left" bgcolor="#FFFFFF"
												...
												<table bgcolor="#FFFFFF" cellspacing="1" cellpadding="0"
													...
													<tbody>
														<tr id="row1">
															<td style="width: 60px;" align="center"><img
																src="images/11.gif" title="增加限制条件" onclick="addRow3()"
																style="cursor: hand;"> <img src="images/22.gif"
																title="移除限制条件" onclick="removeRow()"
																style="cursor: hand;"></td>
															<td><select name="sType0" size="1">
			...
			<%
				...
				if (num == null) {
					System.out.println("你进入无num操作");
					technologylist = Technologymodel.techlistcx(con, pageno1,
							pagesize1);
					pageCount1 = Technologymodel.techpagecx(con, pageno1, pagesize1);
					if (pageno1 > pageCount1) {
						pageno1 = 1;
						technologylist = Technologymodel.techlistcx(con, pageno1,
								pagesize1);
						pageCount1 = Technologymodel.techpagecx(con, pageno1,
								pagesize1);
					}
					...
					pageCount1 = Technologymodel
							.techpagecx(con, pageno1, pagesize1, num, sType0, q0,
									logic1, sType1, q1, logic2, sType2, q2);
					if (pageno1 > pageCount1) {
						pageno1 = 1;
						technologylist = Technologymodel.techlistcx(con, pageno1,
								pagesize1, num, sType0, q0, logic1, sType1, q1,
...
%>
		...
		<td align="center"><%=i%></td>
		<td><a id="href1" href=""
	onclick="createRequest('ShowTechTest.jsp?TechId=<%=tech.getTechId()%>&OrgaId=<%=tech.getOrgaId()%>&look=<%= look %>','refresh');return false;"><%=tech.getTechName()%></a></td>
	...
	%>
							...
							<div style="background: #C0E4FA; position: absolute;"
								...
								<%=i%>
								条最新记录，当前页第<%=pageno1%>/<%=pageCount1%>页 &nbsp;&nbsp; <a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)<1) out.print(1);else out.print(pageno1-1);%>&look=4">上一页</a>&nbsp;&nbsp;<a
									href="qtcx2.jsp?pageno=<%if((pageno1+1)>pageCount1) out.print(pageCount1);else out.print(pageno1+1);%>&look=4">下一页</a>
							</div>
							<form name="form1" method="post" action="qtcx2.jsp?look=<%= look %>">
								<div align="right">
									<a href="qtcx2.jsp?pageno=1&look=4">首页</a>&nbsp;&nbsp;<a
										href="qtcx2.jsp?pageno=<%=pageCount1%>&look=4">尾页</a> 跳转到 <input
										type="text" size="1" style="width: 20px; height: 15px;"
										name="pageno" id="jumpPageNo" ></input>页&nbsp;&nbsp;<a href="#"
										onclick="form1submit()">跳转</a>
								</div>
			...
			<table style="width:100% ;">
							...
							<div style="background: #C0E4FA; position: relative;width:100%">
							<div style="background: #C0E4FA; position: absolute;"
								align="center">
								共有
								<%=i%>
			...
			<table width='100%' >
								...
								<tr align="left" bgcolor="<%=bg%>">
									<td align="center"><%=i%></td>
									<td align="center"><%=expert.getExpertID()%></td>
									<td align="center"><%=expert.getExpertName()%></td>
									<td align="center"><%=expert.getEngageSpec()%></td>
								</tr>
								<%
									} else {
