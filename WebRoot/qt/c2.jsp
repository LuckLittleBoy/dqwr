...
<div align="center">
  ...
  <table id="__01" width="1046" height="968" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="38" colspan="3" background="images/index_0400.jpg"><span id="d" class="STYLE2"> 您的位置：首页->政策查询->分类浏览功能 </span></td>
      ...
      <table width="259"  border="0" cellpadding="0" cellspacing="0" >
	    ...
	    <td colspan="2" valign="top"><table width="785" height="606" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="748" background="images/2temp_11.jpg" ><font color="#FFFFFF"><img src="images/Developer_Icons_064.png" style="vertical-align: middle;" width="32" height="32"><span class="STYLE22">分类检索功能</span></font>&nbsp;</td>
          ...
          <tr>
			...
			<!-- 内容 -->
			<div style="width: 100%;margin-top: 20px" align="center"><font size="6xp">分类浏览功能介绍</font></div>
            	<div style="width: 600px;margin-top: 20px;padding-left: 100px;">
            	<font size="4" style="width: 800px;line-height:32px;">
            	&nbsp;&nbsp;&nbsp;&nbsp;<strong>
            	用户在检索方式中选择“分类浏览”，默认显示分类浏览页面，可选择按政策名称、政策分类、施行范围、颁布形式、序号或文号、制定机关、通过日期、公布日期、施行日期、调整领域、主题词、关键词等不同标引字段对政策数据进行分类查询检索。检索结果显示政策标题、实施日期、有效性等内容列表。
            	</strong>
            	</font>
            	</div>
			<!-- 内容 -->
