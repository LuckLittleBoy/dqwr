 <%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	import="com.dqwr.expert.entity.*" pageEncoding="UTF-8"%>
	<% 
...
<body>
					...
					<div id="refresh">
						<!-- 内容 -->
						<form name="thisform" action="expertlist.jsp" method="get"
													...
													<tbody>
														<tr id="row1">
															...
															<td><select name="sType0" size="1">
																	...
																	<option value="FieldId">专家姓名</option>
			...
			<table width='100%'>
								...
								<tr align="left" bgcolor="<%=bg%>">
									...
									<td align="left"><%=expert.getExpertName()%></td>
							...
							<div style="background: #C0E4FA; position: absolute;"
								...
								条最新记录，当前页第<%=pageno1%>/<%=pageCount1%>页 &nbsp;&nbsp; <a
									href="expertlist.jsp?pageno=<%if((pageno1+1)<1) out.print(1);else out.print(pageno1-1);%>">上一页</a>&nbsp;&nbsp;<a
									href="expertlist.jsp?pageno=<%if((pageno1+1)>pageCount1) out.print(pageCount1);else out.print(pageno1+1);%>">下一页</a>
							</div>
							<form name="form1" method="post" action="qtcx.jsp">
								<div align="right">
									<a href="expertlist.jsp?pageno=1">首页</a>&nbsp;&nbsp;<a
										href="expertlist.jsp?pageno=<%=pageCount1%>">尾页</a> 跳转到 <input
