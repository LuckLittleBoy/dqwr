...
<div
								...
								align="left">
								<!-- 最后记得改网址哦http://www.wanfangdata.com.cn/ -->
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">科技期刊</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">会议论文</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">学位论文</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">中外标准</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">中外专利</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">科技成果</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">政策法规</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">研究报告</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">科技报告</a>
							</div>
							<div
								style="background: #c0e4fa; height: 30px; width: 170px; margin-top: 2px; margin-left: 2px"
								align="left">
								<img style="margin-left: 15px;" src="images/tubiao.jpg"
									width="12px" height="12px;"><a
									href="http://localhost:8080/dqwr/qt/images/wxzy.html">产品样本</a>
							</div>
...
<font ></font>
	    ...
	    <!-- 内容 -->
	    <div style="background:#c0e4fa;height:30px;width:865px;margin-top:5px;margin-left:10px"align="center">文献资源</div>
	    <div align="center" style="background:#ffffff;height:30px;width:865px;margin-top:3px;margin-left:10px"align="left"><select name="search" style="height:20px;width:80px"><option>省内法规</option><option>省外法规</option><option>国外法规</option></select>&nbsp;&nbsp;<input type="text" name="search" style="height:15px;width:350px;">&nbsp;&nbsp;<input type="button" value="查询" style="height:25px;width:40px"></div>
