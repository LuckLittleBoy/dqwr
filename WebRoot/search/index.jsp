...
<div>
 <form action="/dqwr/Project" method="post" enctype="multipart/form-data" onsubmit="return check()">
	<center>
	   <br>
	   <br>
	   <label><h2>请选择需要导入的项目管理Excel表</h2></label><br>
	   <input type="file" name="file" id="fileInput" accept="application/vnd.ms-excel">&nbsp;&nbsp;&nbsp;
