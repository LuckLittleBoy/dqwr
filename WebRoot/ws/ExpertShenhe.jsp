...
%> 
<body bgcolor="#ffffff">
<form id="example" name="example" method="post" action="${pageContext.request.contextPath}/expertsh?ExpertID=<%=expertrs.getInt(1) %>&SH=<%=SH %>&pageno=<%=pageno %>" onsubmit="checkAllTextValid(this)" target="manFrame">
   ...
   <tr>
    ...
    <tr>
     ...
     <td>
         ...
         if(second.equals("其他")){
         %>
          <input type="radio" name="Secondfield" value="其他" checked="checked">其他，请注明(可多选)<input type="text" name="SecondOtherfield" style="width: 117px; " value=<%=expertrs.getString(23) %>>
         <%
         }else{
         %>
          <input type="radio" name="Secondfield" value="其他">其他，请注明(可多选)<input type="text" name="SecondOtherfield" style="width: 117px; ">
         <% 
         }
           }else{
        %>
        ...
        <%   
         ...
         if(third.equals("其他")){
         %>
          <input type="radio" name="Thirdfield" value="其他" checked="checked">其他，请注明(可多选)<input type="text" name="ThirdOtherfield" style="width: 117px; " value=<%=expertrs.getString(25) %>>
         <%
         }else{
         %>
          <input type="radio" name="Thirdfield" value="其他">其他，请注明(可多选)<input type="text" name="ThirdOtherfield" style="width: 117px; ">
         <% 
         }
         }else{
         %>
