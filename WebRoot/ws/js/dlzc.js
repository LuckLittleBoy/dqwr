...
jQuery(function(){
	jQuery.post("/kjzc/ws/jquery/dlzc.jsp",{"pagesize":jQuery("#pagesize").val(),"pageno":jQuery("#pageno").val()},function(response){
		jQuery("#dlzc").html(response);
	});
	
	$("#select").click(function(){
		jQuery.post("/kjzc/ws/jquery/dlzc2.jsp",
