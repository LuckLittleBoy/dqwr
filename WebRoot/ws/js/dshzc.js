...
jQuery(function(){
	jQuery.post("/kjzc/ws/jquery/dshzc.jsp",{"pagesize":jQuery("#pagesize").val(),"pageno":jQuery("#pageno").val()},function(response){
		jQuery("#dshzc").html(response);
	});
	$("#select").click(function(){
		jQuery.post("/kjzc/ws/jquery/dshzc2.jsp",
