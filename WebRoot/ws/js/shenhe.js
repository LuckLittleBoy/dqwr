...
jQuery(function(){
	jQuery.post("/kjzc/ws/jquery/shenhe.jsp",{"pagesize":jQuery("#pagesize").val(),"pageno":jQuery("#pageno").val()},function(response){
		jQuery("#shenhe").html(response);
	});
	$("#select").click(function(){
		jQuery.post("/kjzc/ws/jquery/shenhe2.jsp",
