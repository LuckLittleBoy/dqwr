			...
			$("#search").keyup(function(){
				...
				setTimeout(function(){
					...
					for (var i = 0; i < zdjg.zdjg.length; i++) {
						...
						if (reg.test(zdjg.zdjg[i].zdjgmc) ) {
							...
							html.push("<span title='"+zdjg.zdjg[i]+"' name='"+pid+"' style='width:"+span_width+"px;'>");
							if(x!=0){
								html.push("<br>");
							}
							x=1;
							html.push("<input type='checkbox' value='" + zdjg.zdjg[i].zdjgid + "'>");
							html.push("<span name='"+$("#d1").attr("id")+"' style='margin-left:"+inspan_width+"px;'>" + zdjg.zdjg[i].zdjgmc+ "</span>");
							html.push("</span>");
						}
