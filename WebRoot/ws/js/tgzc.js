...
jQuery(function(){
	jQuery.post("/kjzc/ws/jquery/tgzc.jsp",{"pagesize":jQuery("#pagesize").val(),"pageno":jQuery("#pageno").val()},function(response){
		jQuery("#tgzc").html(response);
	});
	$("#select").click(function(){
		jQuery.post("/kjzc/ws/jquery/tgzc2.jsp",
