          ...
          System.out.println(requid);
			...
			<%
			   while(rs1.next())
			   {
				   ...
				   rs2.next();
			%>
<form id="example" name="example" method="post" action="${pageContext.request.contextPath}/requiresh?requid=<%=rs1.getInt(1) %>&SH=<%=SH %>&pageno=<%=pageno %>" onsubmit="checkAllTextValid(this)" target="manFrame">
  ...
  <table border="1" align="center" bgcolor="#FFFFFF">
   <tr>
	...
	<tr style="display:none">
					<td>&nbsp;&nbsp;&nbsp;用户昵称</td>				
					<td><input type="text" name="username" value="<%=rs2.getString(15)%>"></td>
				</tr>       
  </table>
  </form>
  <% 
