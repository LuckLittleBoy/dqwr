<%@ page language="java" import="com.dqwr.entity.*"
...
<div style="position: relative;min-height: 490px; " >
	<div style="background: #C0E4FA;position: relative;" align="center">添加专题活动</div>
		<div style="margin: 5px 10px 0px 100px;">		    
    <br/>
	<form id="example" name="example" method="post" action="${pageContext.request.contextPath}/addtopicnews" onsubmit="checkAllTextValid(this)" target="manFrame">
	<input type="hidden" name="pageno" style="width:620px;" height="30px" value=<%=pageno %>>
	标题：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="title" style="width:620px;" height="30px">
	<br>
	<input type="hidden" name="topicid" value=<%=topicid %>>
	发布人：&nbsp;&nbsp;&nbsp;<input type="text" name="creator" style="width:620px;"><br>
	发布时间：&nbsp;<input  name="publictime" type="text" onclick="new Calendar().show(this);"  readonly="readonly">
	<br>
	   <table>
	   <tr>内容：</tr>
	   <tr>
