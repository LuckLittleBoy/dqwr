...
<div style="position: relative;min-height: 490px; " >
	<div style="background: #C0E4FA;position: relative;" align="center">免责声明发布</div>
		<div style="margin: 5px 10px 0px 100px;">		    
    <br/>
	<form id="example" name="example" method="post" action="${pageContext.request.contextPath}/Publishmzsm" onsubmit="checkAllTextValid(this)" target="manFrame">
	<br>
	发布人：&nbsp;&nbsp;&nbsp;<input type="text" id="creator" name="creator" style="width:620px;" value=<%=yh.getYHID() %>></br>
