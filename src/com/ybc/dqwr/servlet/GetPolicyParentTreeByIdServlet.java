...
public class GetPolicyParentTreeByIdServlet extends HttpServlet
{
private static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(id!=null&&!id.equals("")){
			try
			{
				policyLists=policyDao.getPolicyFamilyTreeById(id,timeselect,starttime,endtime);
				policyLists1=policyDao.getChildPolicyFamilyTreeById(id,timeselect,starttime,endtime);
				j.put("msg", "ok");
				j.put("policyParentTreeLists", policyLists);
				j.put("policyChildTreeLists", policyLists1);
			} catch (Exception e)
			{
				e.printStackTrace();
				j.put("msg", "error");
