 ...
 */
public class ZcTjServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(keys==1)
		{
			...
			if((pboundary!=null)&&(!pboundary.equals(""))&&(!poffice.equals("")))
			{
				sql+=" where ";
			...
			else if((pboundary!=null)&&(!pboundary.equals("")))
			{
				sql+=" where ";
				sql=Sqlconvert.convert(sql,"pboundary",pboundary,Fangshi[k+1],Condition[k+1]);
				keys=2;
			}
			else if((pboundary!=null)&&(!poffice.equals("")))
			{
		...
		request.getRequestDispatcher("/satpframe/ZCstatistic.jsp").forward(request, response);
	}
