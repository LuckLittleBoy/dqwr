 ...
 */
public class qtzhfxfy extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql=(String)session.getAttribute("sql3");
		...
		request.getRequestDispatcher("qt/qttjfx4.jsp").forward(request, response);
	}
