	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				...
				if(casenumber.equals("1")){
				    ...
				    String caseid1 = mySmartUpload.getRequest().getParameter("caseid1");
				    if(caseid1 != null){
				...
				if(casenumber.equals("2")){
				    ...
				    String caseid2 = mySmartUpload.getRequest().getParameter("caseid2");
				    if(caseid2 != null){
				...
				if(casenumber.equals("3")){
				    ...
				    String caseid3 = mySmartUpload.getRequest().getParameter("caseid3");
				    if(caseid3 != null){
			    ...
			    /*String orgaresult=orgaimpl.insertOrga1(con, orga);
		    ...
		    if(orgaimpl.edittechOrga(conn, orga)){
		    	if(techimpl.updatetech(conn, tech, techid).equals("success")){
		    		//添加典型案例数目为1的情况
		    		if(casenumber.equals("0")){
		 			   ...
		 			   if(caseimpl.updatecase1(conn, case1, techid).equals("success")){
		 			   ...
		 			   if(caseimpl.updatecase1(conn, case1, techid).equals("success")&&caseimpl.updatecase(conn, case2, techid).equals("success")){
		 				  out.print("<script language=javascript>"+"alert('修改成功！');"+"document.location.href='ws/edittechnology.jsp?orgaid="+orgaid+"&techid="+techid+"&pageno="+pageno+"';"+"</script>");
		 			   }else{
		 				  out.print("<script language=javascript>"+"alert('典型案例修改失败!')"+"</script>");
		 			   }
		 		   }else if(casenumber.equals("3")){
		 			   if(caseimpl.updatecase1(conn, case1, techid).equals("success")&&caseimpl.updatecase(conn, case2, techid).equals("success")&&caseimpl.updatecase(conn, case3, techid).equals("success")){
		 				 out.print("<script language=javascript>"+"alert('修改成功！');"+"document.location.href='ws/edittechnology.jsp?orgaid="+orgaid+"&techid="+techid+"&pageno="+pageno+"';"+"</script>");
		 			   }else{
		 				  out.print("<script language=javascript>"+"alert('典型案例修改失败!')"+"</script>");
		 			   }
